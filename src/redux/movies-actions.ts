...
import {MoviesStateType} from "./moviesReducer";
...
type SetMovieDataPayloadType = { movieData: MovieDataType }
...
type ThunkType = ThunkAction<void, MoviesStateType, unknown, MoviesActionTypes>

export const getMovieDataTC = (movieId: string | number | null): ThunkType => (dispatch) => {
